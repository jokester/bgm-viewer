...
import { Subject, SubjectSearchResult, SubjectsIndexQuery, SubjectType } from '../data/api';
            ...
            <div className='flex items-center justify-between'>
              <div>
                ...
                <div className='flex items-center gap-4 mt-1 text-xs text-blue-600'>
                  ...
                  {nsfwFilter !== null && <span>内容: {nsfwFilter ? '仅NSFW内容' : '仅安全内容'}</span>}
                </div>
              </div>
              <Button
                label='修改搜索'
